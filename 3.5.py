...
#tôn trọng admin 
#admik : toky x anhkhoaa
# không xoá
#không thay đổi admin
import requests
...
if __name__ == "__main__":
    print(style.HEADER + 'SPAM SMS CALL SIÊU MẠNH BY TOKYDEV')
    print(style.HEADER + 'Cần tool vip ib admin')
    print(style.HEADER + 'TOKYDEV:AnhKhoaaa')
    print(style.BLUE + '---------------------------------------')
    sdt = input(style.GREEN + "Nhập SĐT: ")
    print(style.BLUE + '---------------------------------------')

    while not re.search("^(0?)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$", sdt):
        print(style.GREEN + "Số điện thoại phải đủ 10 số bạn ơi !!")
        phone = input(style.GREEN + "Nhập Lại SĐT: ")
